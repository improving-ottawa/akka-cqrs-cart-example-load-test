...
//TODO: create a generic trait that any infra impl can satisfy (unify with/adopt CassandraItemPopularityRepository API)
trait JdbcItemPopularityRepository {
...
class JdbcItemPopularityRepositoryImpl() extends JdbcItemPopularityRepository {
